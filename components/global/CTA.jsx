        ...
        <section className={`${cta?.add_image_gallery ? "pt-8 md:pt-24 pb-24 md:pb-0" : "py-24"} ${isContactPage && "!pt-0"}`}>
            {!isContactPage && <div className="container">
                <div className="flex flex-col text-center max-w-[650px] w-full mx-auto">
                    ...
                    <a className="btn mt-16 transition-all duration-300 border border-solid border-accent hover:bg-accent hover:text-white text-accent px-11 py-4 w-fit mx-auto" href="mailto:jack@rivenoakdesign.com">
                        Get in Touch
                    </a>
                </div>
            </div>}
